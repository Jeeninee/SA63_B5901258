...
func (e SubdistrictEdges) ProvinceOrErr() ([]*Province, error) {
	if e.loadedTypes[0] {
...
// QueryProvince queries the province edge of the Subdistrict.
func (s *Subdistrict) QueryProvince() *ProvinceQuery {
	return (&SubdistrictClient{config: s.config}).QueryProvince(s)
}
